// flow-typed signature: a09a8f1741d3de7609aedbb341ee7272
// flow-typed version: <<STUB>>/electron-builder_v^22.13.1/flow_v0.77.0
 ...
 * needed.
 */
declare module 'electron-builder/cli' {
  declare module.exports: any;
}

declare module 'electron-builder/install-app-deps' {
  declare module.exports: any;
}
...
// Filename aliases
declare module 'electron-builder/cli.js' {
  declare module.exports: $Exports<'electron-builder/cli'>;
}
declare module 'electron-builder/install-app-deps.js' {
  declare module.exports: $Exports<'electron-builder/install-app-deps'>;
}
